...
if (especialidadeOuFullstack == 1){
    alert(`Continue se especializando em ${linguagem} para ficar craque na área de ${area}!`);
}
else if (especialidadeOuFullstack == 2){
    alert(`Comece a aprender outras linguagens além de ${linguagem} se você quer se tornar Fullstack!`);
}
else {
